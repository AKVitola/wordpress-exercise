  ...
  <nav class="footer-nav">
    ...
    <!-- <ul class="footer-nav-list">
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="ideja.html"> Ideja</a>
      </li>
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="piesaki_sapni.html">Piesaki Sapni</a>
      </li>
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="uznemejiem.html">Uzņēmējiem</a>
      </li>
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="sapnu_banka.html">Sapņu banka</a>
      </li>
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="sapnus_atbalsta.html">Sapņus atbalsta</a>
      </li>
      <li class="footer-list-item">
        <a class="footer-nav-link underline-animation" href="iedvesmas_stasti.html">Iedvesmas stāsti</a>
      </li>
    </ul> -->
  </nav>
